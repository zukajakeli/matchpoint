        ...
        <div className="mp-result-content">
          {status === "loading" && (
            <div className="mp-result-card">
              <div className="mp-result-spinner" />
              <p>Checking your booking…</p>
            </div>
          )}

          {status === "paid" && booking && (
            <div className="mp-result-card success">
              <div className="mp-result-icon success">✓</div>
          ...
          {status === "pending" && (
            <div className="mp-result-card pending">
              <div className="mp-result-icon pending">⏳</div>
              <h1>Payment Processing…</h1>
              <p className="mp-result-subtext">
                Your payment is being processed. This page will update automatically.
              </p>
              <div className="mp-result-spinner" style={{ marginTop: 16 }} />
            </div>
          )}

          {status === "failed" && (
            <div className="mp-result-card failed">
              <div className="mp-result-icon failed">✕</div>
